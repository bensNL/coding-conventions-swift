...
Where an Xcode project is involved, the organization should be set to `e-Sixt GmbH & Co. KG` and the Bundle Identifier set to `com.sixt.project` where `project` is the name of the tutorial project.
